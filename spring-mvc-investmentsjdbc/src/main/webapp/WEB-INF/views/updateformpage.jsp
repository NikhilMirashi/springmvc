...
<body>
	...
	<form action="updateInvestment" method="post">
		...
		Name <input type="text" name="planName" value="${investment.planName }" readonly>
		<br> Entry Age
		<input type="text" name="entryAge" value="${investment.entryAge }"readonly><br> 
		Entry PlanId <input type="hidden"
			name="planId" value="${investment.planId }" readonly><br>
